...
// 3. JIKA PRODUK TIDAK DITEMUKAN, KEMBALIKAN KE HALAMAN UTAMA
if (!$product) {
...
<head>
    ...
    <style>
        /* STYLING DASAR UNTUK HALAMAN DETAIL */
...
<body>
    ...
    <div class="container">
        ...
        <div class="product-details">
            ...
            <?php 
            // Mengecek apakah kategori mengandung kata "parfum" (menggunakan strtolower agar huruf besar/kecil terbaca sama)
            if (strpos(strtolower($product['category']), 'parfum') !== false): 
            ?>
                <div class="sizes-title">Deskripsi Produk</div>
                <div class="desc-text">
                    Wewangian eksklusif dari Aether Collective. Dirancang khusus dengan bahan-bahan premium yang memberikan aroma elegan, mewah, dan tahan lama sepanjang hari. Pilihan tepat untuk melengkapi gaya hidup modern Anda.
                </div>
